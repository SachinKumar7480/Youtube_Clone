      ...
      <div class="main-section">
        <div class="main-left">
          ...
          <button class="yt-side-button">
            ...
            <span class="side-channel-label white">Tom & Jerry</span>
          </button>

          <button class="yt-side-button">
            <img src={ndtv} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">Shinchan</span>
          </button>

          <button class="yt-side-button">
            <img src={modi} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">Mr. Bean</span>
          </button>

          <button class="yt-side-button">
            <img src={tseries} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">POGO World</span>
          </button>

          <button class="yt-side-button">
            <img src={coke} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">Cartoon</span>
          </button>
        </div>
        ...
        <div class="main-right">
          <div className="navbar-container">
            <div class="navbar">
              ...
              <div class="navbar-items white">Cartoon Shows</div>
              <div class="navbar-items white">Shinchan</div>
              <div class="navbar-items white">Doremon</div>
              <div class="navbar-items white">Mr. Bean</div>
              <div class="navbar-items white">Anime</div>
              <div class="navbar-items white">Old Episodes</div>
              <div class="navbar-items white">Indian Games</div>
              <div class="navbar-items white">Hollywood Movies</div>
              <div class="navbar-items white">Dancing Shows</div>
